      ...
      <div className="footer">
        <footer class="footer-distributed">
          <div class="footer-left">
            <img src= "./images/portfolioimg.png" />
            <h3>
              Arjit<span>Gupta</span>
            </h3>

            <p class="footer-links">
            <Link to="/">Home</Link> | <Link to="/experience">Work</Link> | <Link to ="/skills">Skills</Link> | <Link to="/project">Projects</Link> | <Link to="/contact">Contact Me</Link>
            </p>
